...
eval "cat ~/Apple/assets/download.txt"
printf "\n\n\033[1;35mAppleUserbot is being installed... ✨\033[0m"
...
eval "rm -rf ~/Apple 2>/dev/null"
eval "cd && git clone https://github.com/AppleUserbot/Apple && cd Apple"
...
if [[ -z "${NO_AUTOSTART}" ]]; then
    ...
    echo 'clear && . <(wget -qO- https://github.com/AppleUserbot/Apple/raw/master/banner.sh) && cd ~/Apple && python3 -m hikka' > ~/.bash_profile"

    printf "\r\033[K\033[0;32mAutostart enabled!\e[0m\n"
fi

echo -e "\033[0;96mStarting AppleUb...\033[0m"
echo -e "\033[2J\033[3;1f"

printf "\033[1;32mAppleUb is starting...\033[0m\n"
